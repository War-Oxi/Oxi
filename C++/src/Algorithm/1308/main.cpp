...
//    int start_year(2008), start_month(12), start_day(27);
//    int end_year(2009), end_month(1), end_day(22);
//    int start_year(2024), start_month(2), start_day(15);
//    int end_year(2024), end_month(6), end_day(17);
...
//            if (start_day > end_day)
//            {
//                for(start_month; start_month + 1 > end_month; start_month--)
//                {
//                    count -= g_month[start_month - 1];
//                }
//            }
